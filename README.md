...
see [Indeed Hacktoberfest 2020](https://engineering.indeedblog.com/indeed-hacktoberfest-2020/) for details -- that can net you additional swag: Jackson is one of OSS projects eligible and supported
